  ...
  return (
    <div id="skills" className={styles.skills}>
      ...
      <div className={styles.programingSkills}>
        ...
        <h4>Djanjo</h4><img src={django} alt="Django" className={styles.customIcon} style={{ filter: "brightness(0) saturate(100%) invert(14%) sepia(14%) saturate(2300%) hue-rotate(88deg) brightness(95%) contrast(86%)" }} />
